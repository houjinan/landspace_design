...
var form = $("<form/>", {
      action: "/admin/attachments", //设置上传图片的路由，配置在初始化时
      style: 'display:none',
      method: 'post',
      enctype: 'multipart/form-data'
    });
tinymce.PluginManager.add('uploadimage', function (editor) {
    ...
    function selectLocalImages() {
        var dom = editor.dom;
        var input_f = $('<input type="file" name="attachment[avatar]" id="attachment_avatar" accept="image/jpg,image/jpeg,image/png,image/gif" multiple="multiple">');
...
(function() {
  if (typeof tinyMCE != 'undefined') {
    tinyMCE.init({
      ...
      language: "zh_CN",
      // toolbar: ["fontselect fontsizeselect |  bullist numlist outdent indent | code | bold italic underline | forecolor backcolor | alignleft aligncenter alignright | undo redo |link unlink uploadimage| paste"],
      plugins: "paste,image,imagetools,link,table,textcolor,code,preview,media,fullscreen,uploadimage",
